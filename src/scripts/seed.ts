...
async function main() {
  ...
  const lawyers = [
    ...
    },
    {
      name: 'Bruce S. Allen',
      title: 'Partner',
      bio: 'Bruce S. Allen received his Juris Doctor degree (May 1976) from Delaware Law School of Widener University and Bachelor of Science degree (May 1973) from Philadelphia University. He has been a Partner in Law Offices of Rovner, Allen, Rovner and Sigman since 1979.',
