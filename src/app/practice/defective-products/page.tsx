      ...
      <div className="hidden lg:block">
        ...
        <section className="hero-professional">
          <div className="hero-content">
            ...
            <p>Expert representation for product liability cases</p>
          </div>
        </section>
        ...
        <section className="section">
          <div className="practice-detailed-content">
            ...
            <div className="practice-text-content">
              <h1 className="practice-title">Product Liability Attorney & Lawyer</h1>
              ...
              <div className="practice-description">
                <p>
                  When defective products cause injuries, manufacturers and distributors can be held responsible. We help victims of dangerous and defective products seek justice. At {firmName}, our product liability attorneys have extensive experience representing clients who have been injured by defective products.
                </p>
                
                <p>
                  Product liability cases can be complex and require extensive investigation and expert testimony. Our attorneys work with engineers, safety experts, and other professionals to prove that a product was defective and caused your injuries. We have successfully represented clients in cases involving defective automobiles, dangerous pharmaceuticals, defective medical devices, and faulty consumer products.
                </p>
                
                <p>
                  If you or a loved one has been injured by a defective product, you may be entitled to compensation for your medical expenses, lost wages, pain and suffering, and other damages. Contact {firmName} today for a free consultation to discuss your case.
                </p>
              </div>

              <div className="practice-features">
                <h2 className="features-title">Types of Defective Products We Handle:</h2>
                <div className="features-list">
                  <div className="feature-item">
                    <h3>Defective Automobiles</h3>
                  </div>
                  
                  <div className="feature-item">
                    <h3>Dangerous Pharmaceuticals</h3>
                  </div>
                  ...
                  <div className="feature-item">
                    <h3>Faulty Consumer Products</h3>
                  </div>
                  
                  <div className="feature-item">
                    <h3>Industrial Equipment Failures</h3>
                  </div>
                  
                  <div className="feature-item">
                    <h3>Defective Children's Products</h3>
                  </div>
                  
                  <div className="feature-item">
                    <h3>Dangerous Household Items</h3>
                  </div>
                  
                  <div className="feature-item">
                    <h3>Defective Electronics</h3>
                  </div>
                </div>
              </div>
              ...
              <div className="practice-description">
                <p>
                  Product liability law holds manufacturers, distributors, and retailers responsible for injuries caused by defective products. There are three main types of product defects: design defects, manufacturing defects, and marketing defects (failure to warn). Our attorneys will investigate your case to determine the type of defect and hold the responsible parties accountable.
                </p>
                
                <p>
                  We understand the devastating impact that defective products can have on individuals and families. Our goal is to help you recover the compensation you deserve while holding manufacturers accountable for putting dangerous products on the market.
                </p>
                
                <p>
                  If you or a loved one has been injured by a defective product, don't wait to get the legal help you need. Contact {firmName} today for a free consultation. We're here to fight for your rights and help you get the compensation you deserve.
                </p>
              </div>
      ...
      <div className="block lg:hidden w-full bg-gradient-to-b from-white to-orange-50 min-h-screen">
        ...
        <section className="relative w-full h-44 overflow-hidden flex items-center justify-center rounded-b-3xl shadow-md mb-4">
          ...
          <div className="relative z-10 text-center text-white px-4 w-full">
            <h1 className="text-2xl font-bold mb-2" style={{textShadow:'0 2px 8px #000', letterSpacing: '-0.01em'}}>Defective Products</h1>
            <p className="text-base mb-4 font-medium" style={{textShadow:'0 2px 8px #000'}}>Expert representation for product liability cases</p>
          </div>
        </section>
        ...
        <section className="px-4 py-4">
          <div className="flex flex-col gap-6">
            <h2 className="text-xl font-bold text-slate-900 mb-2">Product Liability Attorney & Lawyer</h2>
            <div className="bg-orange-50 rounded-xl p-4 shadow-sm">
              <p className="text-sm font-semibold text-slate-900 mb-2">Free Initial Consultation</p>
              <p className="text-sm font-semibold text-slate-900">No Fee if No Recovery!</p>
            </div>
            ...
            <div className="flex flex-col gap-4 text-base text-gray-800 leading-relaxed">
              <p>When defective products cause injuries, manufacturers and distributors can be held responsible. We help victims of dangerous and defective products seek justice. At {firmName}, our product liability attorneys have extensive experience representing clients who have been injured by defective products.</p>
              <p>Product liability cases can be complex and require extensive investigation and expert testimony. Our attorneys work with engineers, safety experts, and other professionals to prove that a product was defective and caused your injuries. We have successfully represented clients in cases involving defective automobiles, dangerous pharmaceuticals, defective medical devices, and faulty consumer products.</p>
              <p>If you or a loved one has been injured by a defective product, you may be entitled to compensation for your medical expenses, lost wages, pain and suffering, and other damages. Contact {firmName} today for a free consultation to discuss your case.</p>
            </div>

            {/* Mobile Types of Products */}
            <div className="bg-orange-50 rounded-xl p-4 shadow-sm">
              <h3 className="font-bold text-slate-900 mb-3 text-lg">Types of Defective Products We Handle:</h3>
            ...
            <div className="flex flex-col gap-4 text-base text-gray-800 leading-relaxed">
              ...
              <p>We understand the devastating impact that defective products can have on individuals and families. Our goal is to help you recover the compensation you deserve while holding manufacturers accountable for putting dangerous products on the market.</p>
              <p>If you or a loved one has been injured by a defective product, don't wait to get the legal help you need. Contact {firmName} today for a free consultation. We're here to fight for your rights and help you get the compensation you deserve.</p>
            </div>
          </div>
        </section>
