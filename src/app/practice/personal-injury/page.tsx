        ...
        <section className="section" style={{padding:'2.5rem 0'}}>
          <div style={{display:'flex',flexDirection:'row',gap:'2.5rem',alignItems:'flex-start',justifyContent:'center',maxWidth:'1100px',margin:'0 auto',flexWrap:'wrap'}}>
            <div style={{flex:'0 0 320px',maxWidth:'320px',width:'100%',display:'flex',alignItems:'flex-start',justifyContent:'center'}}>
              <Image 
                src="/photos/personal-injury.jpg" 
      ...
      <div className="block lg:hidden w-full bg-gradient-to-b from-white to-orange-50 min-h-screen">
        ...
        <section className="px-4 py-4">
          <div className="flex flex-col gap-6">
            <h2 className="text-xl font-bold text-slate-900 mb-2">Personal Injury Lawyer & Attorney</h2>
            ...
            <div className="bg-orange-50 rounded-xl p-4 shadow-sm">
              <h3 className="font-bold text-slate-900 mb-3 text-lg">Types of Cases We Handle</h3>
