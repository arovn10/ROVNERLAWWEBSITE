      ...
      <div className="block lg:hidden w-full bg-gradient-to-b from-white to-orange-50 min-h-screen">
        ...
        <section className="relative w-full h-44 overflow-hidden flex items-center justify-center rounded-b-3xl shadow-md mb-4">
          ...
          <div className="relative z-10 text-center text-white px-4 w-full">
            <p className="text-2xl font-bold mb-2" style={{textShadow:'0 2px 8px #000', letterSpacing: '-0.01em'}}>Family Law</p>
        ...
        <section className="px-4 py-4">
          <div className="flex flex-col gap-6">
            <h2 className="text-xl font-bold text-slate-900 mb-2">Family Law Attorney & Lawyer</h2>
            <div className="bg-orange-50 rounded-xl p-4 shadow-sm">
              ...
              <p className="text-sm font-semibold text-slate-900">Compassionate Legal Representation</p>
            </div>
            ...
            {/* Mobile Services */}
            <div className="bg-orange-50 rounded-xl p-4 shadow-sm">
              <h3 className="font-bold text-slate-900 mb-3 text-lg">Family Law Services We Provide:</h3>
