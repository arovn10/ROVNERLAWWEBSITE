...
export default function EditPracticeAreaPage({ params }: { params: { id: string } }) {
  // TODO: Fetch practice area by ID
  return (
    <div className="admin-section">
      <h1 className="text-2xl font-bold mb-6">Edit Practice Area</h1>
      <form className="admin-form">
        ...
        <button type="submit" className="admin-btn admin-btn-primary mt-4">Save Changes</button>
      </form>
    </div>
  );
} 