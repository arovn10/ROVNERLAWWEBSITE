        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex-shrink-0">
              <span className="text-xl sm:text-2xl font-bold text-orange-600">Rovner Law</span>
            </Link>
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link href="/attorneys" className="text-gray-700 hover:text-orange-600 transition-colors">
              Attorneys
            </Link>
            ...
            <Link href="/locations" className="text-gray-700 hover:text-orange-600 transition-colors">
              Locations
            </Link>
            <Link href="/photo-gallery" className="text-gray-700 hover:text-orange-600 transition-colors">
              Photo Gallery
            </Link>
            <Link href="/in-the-news" className="text-gray-700 hover:text-orange-600 transition-colors">
              In The News
            </Link>
          ...
          <div className="hidden lg:flex items-center space-x-4">
            <a href="tel:215-259-5958" className="flex items-center text-orange-600 font-semibold">
